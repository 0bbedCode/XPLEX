...
public class UiGlobals {
    ...
    public static final String SORT_TARGET_SDK = "Target SDK";

    public static final String FILTER_CONFIGURED = "Configured";
    public static final String FILTER_LAST_UPDATE = "Last Updated";
